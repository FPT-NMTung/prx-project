<%-- 
    Document   : recipes_detail
    Created on : Jul 13, 2022, 11:40:58 PM
    Author     : ntduo
--%>
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Bellaria - a Delicious Cakes and Bakery HTML Template | Recipe Single</title>
        ...
        <div class="page-wrapper">
            ...
            <section class="recipes-section-two">
                <div class="auto-container">
                    <div class="recipe-single">
                        <div class="recipe-block-two">
                            ...
                            <div class="lower-content">
                                <ul class="post-info">
                                    <li><span class="icon fa fa-user"></span> by ${recipe.author}</li>
                                </ul>
                                ...
                                <div class="cooked-recipe-info clearfix">
                                    <div class="cooked-left">
                                        <span class="cooked-servings">
                                            <span class="cooked-servings-icon"><i class="cooked-icon fa fa-utensils"></i></span>
                                            <strong class="cooked-meta-title">Yields</strong>
                                            <a href="#">1 Serving</a>
                                            <select name="servings" class="sortby-select select2-offscreen cooked-servings-changer">
                                                <option value="/recipes/red-velvet-cake/" selected>Default (1 Serving)</option>
                                                <option value="/recipes/red-velvet-cake/?servings=2">Double (2 Servings)</option>
                                                <option value="/recipes/red-velvet-cake/?servings=3">Triple (3 Servings)</option>
                                            </select>
                                        </span>
                                    </div>

                                    <div class="cooked-right">
                                        <span class="cooked-time">
                                            <span class="cooked-time-icon"><i class="cooked-icon far fa-clock"></i></span>
                                            <strong class="cooked-meta-title">Prep Time</strong>${recipe.prepTime}
                                        </span>

                                        <span class="cooked-time">
                                            <span class="cooked-time-icon"><i class="cooked-icon far fa-clock"></i></span>
                                            <strong class="cooked-meta-title">Cook Time</strong>${recipe.cookTime}
                                        </span>

                                        <span class="cooked-time">
                                            <span class="cooked-time-icon"><i class="cooked-icon far fa-clock"></i></span>
                                            <strong class="cooked-meta-title">Total Time</strong>${recipe.totalTime}
                                        </span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                                            ...
                                            <div class="footer-widget logo-widget">
                                                <figure class="footer-logo"><img src="client/images/footer-logo.png" alt=""></figure>
                                            </div>
                                        </div>
                    ...
                    <script src="client/js/jquery.modal.min.js"></script>
