<%-- 
    ...
    Created on : Jul 13, 2022, 1:10:20 AM
    Author     : MSI - GL
--%>
                            ...
                            <div class="related-products">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="shop-item col-lg-4 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                <figure class="image"><a href="product-detail.jsp"><img src="http://html.cwsthemes.com/bellaria/images/resource/products/3.jpg" alt=""></a></figure>
                                                <div class="btn-box"><a href="shopping-cart.html">Add to cart</a></div>
                                            </div>
                                            <div class="lower-content">
                                                <h4 class="name"><a href="product-detail.jsp">French Macaroon</a></h4>
                                    ...
                                    <div class="shop-item col-lg-4 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><a href="product-detail.jsp"><img src="http://html.cwsthemes.com/bellaria/images/resource/products/6.jpg" alt=""></a></figure>
                                                <div class="btn-box"><a href="shopping-cart.html">Add to cart</a></div>
                                            </div>
                                            <div class="lower-content">
                                                <h4 class="name"><a href="product-detail.jsp">Happy Ninja</a></h4>
                                                <div class="rating"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star light"></span></div>
                                    ...
                                    <div class="shop-item col-lg-4 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><a href="product-detail.jsp"><img src="http://html.cwsthemes.com/bellaria/images/resource/products/7.jpg" alt=""></a></figure>
                                                <div class="btn-box"><a href="shopping-cart.html">Add to cart</a></div>
                                            </div>
                                            <div class="lower-content">
                                                <h4 class="name"><a href="product-detail.jsp">Hearts Lollipop</a></h4>
                                                <div class="rating"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star light"></span></div>
                                                <div class="price">$17.00</div>
                                            </div>
                                        </div>
