<%-- 
    ...
    Created on : Jul 14, 2022, 8:22:01 AM
    Author     : kaiok
--%>
...
<head>
<meta charset="utf-8">
<title>Bellaria - a Delicious Cakes and Bakery HTML Template | Content Elements</title>
                            ...
                            <ul class="navigation menu-left clearfix">
                                ...
                                <li class="dropdown current"><a href="about-us.html">Pages</a>
                                    <ul>
                                        ...
                                        <li class="current"><a href="content-elements.html">Content Elements</a></li>
    ...
    <section class="content-elements" id="page">
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box with-icon sucess">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box with-icon error">
                        <div class="icon-box"><span class="icon fa fa-ban"></span></div>
                        <h4>Error Box</h4>
                        <p>Vestibulum sodales pellentesque nibi</p>
                        <button class="close-btn"><span class="fa fa-times"></span></button>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 margin-bottom-50">
                    <div class="default-tabs tabs-box">
                        ...
                        <ul class="tab-buttons clearfix">
                            <li class="tab-btn active-btn" data-tab="#tab1">Description</li>
                            <li class="tab-btn" data-tab="#tab2">Reviews</li>
                            <li class="tab-btn" data-tab="#tab3">Tags</li>
                        </ul>
            ...
            <div class="cws_divider"><img src="images/icons/icon-devider-gray.png" alt=""></div>
            ...
            <div class="deviders text-center">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat lorem lorem. Pellentesque id iaculis orci, ut facilisis urna. Morbi vitae lorem ut felis semper consectetur. Nullam eget consectetur lorem, non convallis dolor. Quisque ac enim nec purus cursus venenatis ut eget sapien. Vivamus ut nibh ut neque consequat faucibus at congue urna. Nullam in aliquet nibh, condimentum ornare lorem.</p>

                <div class="cws_divider"></div>

                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat lorem lorem. Pellentesque id iaculis orci, ut facilisis urna. Morbi vitae lorem ut felis semper consectetur. Nullam eget consectetur lorem, non convallis dolor. Quisque ac enim nec purus cursus venenatis ut eget sapien. Vivamus ut nibh ut neque consequat faucibus at congue urna. Nullam in aliquet nibh, condimentum ornare lorem.</p>

                <div class="cws_divider"><img src="images/icons/divider_13.png" alt=""></div>

                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat lorem lorem. Pellentesque id iaculis orci, ut facilisis urna. Morbi vitae lorem ut felis semper consectetur. Nullam eget consectetur lorem, non convallis dolor. Quisque ac enim nec purus cursus venenatis ut eget sapien. Vivamus ut nibh ut neque consequat faucibus at congue urna. Nullam in aliquet nibh, condimentum ornare lorem.</p>

                <div class="cws_divider"><img src="images/icons/divider_12.png" alt=""></div>

                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat lorem lorem. Pellentesque id iaculis orci, ut facilisis urna. Morbi vitae lorem ut felis semper consectetur. Nullam eget consectetur lorem, non convallis dolor. Quisque ac enim nec purus cursus venenatis ut eget sapien. Vivamus ut nibh ut neque consequat faucibus at congue urna. Nullam in aliquet nibh, condimentum ornare lorem.</p>

                <div class="cws_divider"><img src="images/icons/divider_11.png" alt=""></div>
            </div>
            ...
            <!-- buttons -->
            <div class="buttons">
                <div class="upper-box" style="background-image: url(https://via.placeholder.com/1920x1080);">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-two large"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two regular"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two small"><span></span>Small button<span></span></a>
                        </div>

                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-two large border-pink"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two regular border-pink"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two small border-pink"><span></span>Small button<span></span></a>
                        </div>

                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-two large with-bg"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two regular with-bg"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two small with-bg"><span></span>Small button<span></span></a>
                        </div>

                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-one alt large"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-one alt regular"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-one alt small"><span></span>Small button<span></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="lower-box">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-two large bg-pink"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two regular bg-pink"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two small bg-pink"><span></span>Small button<span></span></a>
                        </div>

                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-two large bg-sky"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two regular bg-sky"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two small bg-sky"><span></span>Small button<span></span></a>
                        </div>

                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="#" class="theme-btn btn-style-two large border-sky"><span></span>large button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two regular border-sky"><span></span>Middle button<span></span></a>
                            <a href="#" class="theme-btn btn-style-two small border-sky"><span></span>Small button<span></span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="progress-bars row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="bar-item">
                        <div class="skill-header clearfix">
                            <div class="skill-title">Cheesecakes</div>
                        </div>
                        <div class="skill-bar">
                    ...
                    <div class="bar-item">
                        <div class="skill-header clearfix">
                            <div class="skill-title">Cakes Pies</div>
                        </div>
                        <div class="skill-bar">
                            <div class="bar-inner"><div class="bar progress-line" data-width="85"><div class="skill-percentage"><div class="count-box"><span class="count-text" data-speed="2000" data-stop="85">0</span>%</div></div></div></div>
                        </div>
                    </div>
                    ...
                    <div class="bar-item">
                        <div class="skill-header clearfix">
                            <div class="skill-title">Cake Pops</div>
                        </div>
                        <div class="skill-bar">
                            <div class="bar-inner"><div class="bar progress-line" data-width="70"><div class="skill-percentage"><div class="count-box"><span class="count-text" data-speed="2000" data-stop="70">0</span>%</div></div></div></div>
                        </div>
                    </div>                    
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="bar-item style-two">
                        <div class="skill-header clearfix">
                            <div class="skill-title">Fruitcakes</div>
                        </div>
                        <div class="skill-bar">
                    ...
                    <div class="bar-item style-two">
                        <div class="skill-header clearfix">
                            <div class="skill-title">Chocolates</div>
                        </div>
                        <div class="skill-bar">
                    ...
                    <div class="bar-item style-two">
                        <div class="skill-header clearfix">
                            <div class="skill-title">Lollypops</div>
                        </div>
                        <div class="skill-bar">
                            <div class="bar-inner"><div class="bar progress-line" data-width="99"><div class="skill-percentage"><div class="count-box"><span class="count-text" data-speed="2000" data-stop="99">0</span>%</div></div></div></div>
                        </div>
                    </div>                    
                </div>
            </div>

            <div class="cws_divider margin-top-70"><img src="images/icons/icon-devider-gray.png" alt=""></div>
            ...
            <!-- Portfolio Carousel -->
            <div class="four-items-carousel owl-carousel owl-theme default-dots">
                <!-- Portfolio Block -->
                <div class="portfolio-block">
                    <div class="inner-box">
                        <div class="image-box"><figure class="image"><img src="https://via.placeholder.com/300x300" alt=""></figure></div>
                ...
                <div class="portfolio-block">
                    <div class="inner-box">
                        ...
                        <div class="portfolio-hover">
                            ...
                            <a href="https://via.placeholder.com/620x640" class="lightbox-image link" data-fancybox="portfolio"></a>
                            <h3><a href="portfolio-single.html">Dapibus lectus</a></h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="cws_divider margin-top-40"><img src="images/icons/icon-devider-gray.png" alt=""></div>
            ...
            <div class="single-item-carousel owl-carousel owl-theme default-arrows">
                <div class="gallery-item">
                    <figure class="image"><a href="https://via.placeholder.com/1920x1080" class="lightbox-image" data-fancybox="gallery"><img src="https://via.placeholder.com/1920x1080" alt=""></a></figure>
                </div>
            ...
            <div class="cws_divider margin-top-50"><img src="images/icons/icon-devider-gray.png" alt=""></div>
            ...
            <div class="row">
                <!-- Pie Graph -->
                <div class="pie-graph col-lg-3 col-md-6 col-sm-12">
                    <div class="graph-outer">
                        <input type="text" class="dial" data-fgColor="#5fcac7" data-bgColor="#f9f9f9" data-width="216" data-height="216" data-linecap="normal"  value="75">
                ...
                <div class="pie-graph col-lg-3 col-md-6 col-sm-12">
                    <div class="graph-outer">
                        <input type="text" class="dial" data-fgColor="#ff91a4" data-bgColor="#f9f9f9" data-width="216" data-height="216" data-linecap="normal"  value="45">
                        <div class="inner-text count-box"><span class="count-text txt" data-stop="45" data-speed="2000"></span>%</div>
                    </div>
                    <h4>Cupcakes</h4>
                </div>
                ...
                <div class="pie-graph col-lg-3 col-md-6 col-sm-12">
                    <div class="graph-outer">
                        <input type="text" class="dial" data-fgColor="#5fcac7" data-bgColor="#f9f9f9" data-width="216" data-height="216" data-linecap="normal"  value="80">
                ...
                <div class="pie-graph col-lg-3 col-md-6 col-sm-12">
                    <div class="graph-outer">
                        <input type="text" class="dial" data-fgColor="#ff91a4" data-bgColor="#f9f9f9" data-width="216" data-height="216" data-linecap="normal"  value="50">
            ...
            <div class="row">
                ...
                <div class="banner-box col-lg-4 col-md-12 col-sm-12">
                    <div class="inner-box text-right" style="background-image: url(https://via.placeholder.com/640x500);">
                        <h4>Sweet<br>For Your<br> Party</h4>
                        <a href="shop.html" class="theme-btn btn-style-two small bg-pink"><span></span>Shop Now<span></span></a>
                    </div>
                </div>

                <!-- Banner Box -->
                <div class="banner-box col-lg-4 col-md-12 col-sm-12">
                    <div class="inner-box" style="background-image: url(https://via.placeholder.com/640x500);">
                        <h4>Any Design<br>For You</h4>
                        <a href="shop.html" class="theme-btn btn-style-two small bg-sky"><span></span>Shop Now<span></span></a>
                    </div>
                </div>

                <!-- Banner Box -->
                <div class="banner-box col-lg-4 col-md-12 col-sm-12">
                    <div class="inner-box text-center" style="background-image: url(https://via.placeholder.com/640x500);">
                        <h2>-50%</h2> 
                        <h4>Just Today</h4>
                        <a href="shop.html" class="theme-btn btn-style-two small bg-pink"><span></span>Shop Now<span></span></a>
                    </div>
            ...
            <div class="cws_divider margin-top-20"><img src="images/icons/icon-devider-gray.png" alt=""></div>
            ...
            <div class="testimonial-carousel-two owl-carousel owl-theme default-dots no-arrows text-center">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        ...
                        <div class="text">Quisque eros ligula, tincidunt eget feugiat non, suscipit a odio. Morbi mattis.</div>
                        <div class="name">Mr Twinkle</div>
                    </div>
                </div>
            </div>

            <div class="cws_divider margin-top-30 margin-bottom-50"><img src="images/icons/divider_12.png" alt=""></div>

            <!-- Testimonial Carousel -->
            <div class="single-item-carousel owl-carousel owl-theme default-dots no-arrows">
                ...
                <div class="testimonial-block-two style-two">
                    <div class="inner-box">
                        ...
                        <div class="text">Quisque eros ligula, tincidunt eget feugiat non, suscipit a odio. Morbi mattis quam non metus pretium, gravida tristique ante <br> tempor.imperdiet, venenatis eros ac, mattis mauris. Nam ac purus justo.</div>
                        <div class="name">Maria Doe</div>
                    </div>
                </div>
