                    ...
                    <div class="col-7">
                        <div class="card" style="padding: 40px">
                            <form action="create" method="POST">
                                ...
                                <p style="margin: 10px 0 0">Long Description: </p><textarea rows="6" type="text" name="long" class="form-control" required ></textarea>
                                <p style="margin: 10px 0 0">Image: </p><input type="text" name="image" class="form-control" required/>
                                <p style="margin: 10px 0 0">Category: </p><input type="text" name="category" class="form-control" required/>
                                <p style="margin: 10px 0 0">Tag: </p><input type="text" name="tag" class="form-control" required/>
                                <div style="display: flex; align-items: center; margin: 20px 0 0 0; column-gap: 30px">
                                    <button style="margin: 0" class="btn btn-primary" type="submit">Create</button>
                                </div>
                            </form>
                        </div>
                    </div>
